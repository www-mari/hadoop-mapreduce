...
public class Comments {
    ...
    public static class Mapper1 extends Mapper<Object, Text, Text, Text> {
        ...
        protected void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            if(valueStr.length == 8){
                ...
                String comments = valueStr[5];

                String [] formattime = timestamp.split(" ");
                String time = formattime[0]; // yyyy-mm-dd

                String cc = user + "~" + time + "~" + comments;

                if(!cc.contains("replies")){
    ...
    public static class Reducer1 extends Reducer<Text, Text, Text, Text> {
        ...
        // hashmap: <key: id, value: [# comments, timestamp, user]>
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "top 100 comments");
        job.setJarByClass(Comments.class);
        job.setMapperClass(Comments.Mapper1.class);
        job.setReducerClass(Comments.Reducer1.class);
        ...
        // MultipleInputs.addInputPath(job, new Path(args[0]), TextInputFormat.class, Mapper1.class); //formatted tweets.csv
        // MultipleInputs.addInputPath(job, new Path(args[1]), TextInputFormat.class, Mapper2.class); //formatted bitcoin.csv
