...
public class Retweets {
    ...
    public static class Reducer1 extends Reducer<Text, Text, Text, Text> {
        ...
        // hashmap: <key: id, value: [# retweets, timestamp, user]>
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "top 100 retweets");
        job.setJarByClass(Retweets.class);
        job.setMapperClass(Retweets.Mapper1.class);
        job.setReducerClass(Retweets.Reducer1.class);
